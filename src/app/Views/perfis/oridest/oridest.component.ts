...
export class OridestComponent implements OnInit {
  ...
  aCabGrid = [
    ...
    { property: 'uf-ori',   label: 'Uf de Origem',          width: '400px', required: true        },
    { property: 'desc-ori', label: 'Descrição da Origem',   width: '400px', required: true        },
    { property: 'uf-des',   label: 'Uf de Destino',         width: '400px', required: true        },
    { property: 'desc-des', label: 'Descrição do Destino',  width: '400px', required: true        },
  ];
